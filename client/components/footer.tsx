      ...
      <div className="container pt-2">
        <div className="flex justify-center space-x-2">
          <a
            ...
            type="button"
            className="rounded-full bg-transparent p-3 font-medium uppercase leading-normal text-surface transition duration-150 ease-in-out hover:bg-neutral-100 focus:outline-none focus:ring-0 dark:text-white dark:hover:bg-black flex items-center justify-center"
